    ...
    <footer className="pt-5">
      <Container>
        <Row>
          ...
          <a target="_blank" href="mailto:hellofigant@in" className="d-block" >hellofigant@in</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:8750214151" className="d-block" >8750214151</a>
          </div>
        ...
        <p className="text-light">   @ 2025. rawatcoder All rights reserved </p> 
        </Col>
        </Row>
